...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className={`w-64 bg-white shadow-lg flex flex-col fixed h-full z-40 transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${
