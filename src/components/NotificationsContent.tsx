...
const NotificationsContent: React.FC = () => {
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      description: 'Officer Ayam Idumba (Badge: P-456) is pending approval for system access.',
    ...
    },
    {
      ...
      description: 'Vehicle BA-1387-18 flagged for multiple violations. Immediate action required.',
    ...
    },
    {
      ...
      description: 'Pending approval for user "John Mensah" has been processed and approved.',
      timestamp: 'Yesterday',
      read: true,
    },
    {
